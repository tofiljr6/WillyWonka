...
DELIMITER //
CREATE PROCEDURE innerAddChocolate(IN id INT, IN name_in VARCHAR(50), IN producer_in VARCHAR(50), IN type_in ENUM('bitter', 'milky', 'white'),
...
DELIMITER //
CREATE OR REPLACE PROCEDURE addChocolate(IN id INT, IN name VARCHAR(50), IN producer VARCHAR(50), IN type ENUM('bitter', 'milky', 'white'),
                                         IN flavour INT UNSIGNED, mass INT UNSIGNED)
  BEGIN
...
DELIMITER //
CREATE PROCEDURE innerAddCandy(IN id INT, IN name_in VARCHAR(50), IN producer_in VARCHAR(50), IN type_in VARCHAR(50),
                               IN flavour_in INT UNSIGNED, mass_in INT UNSIGNED)
  BEGIN
...
DELIMITER //
CREATE OR REPLACE PROCEDURE addCandy(IN id INT, IN name VARCHAR(50), IN producer VARCHAR(50), IN type VARCHAR(50),
                                     IN flavour INT UNSIGNED, mass INT UNSIGNED)
  BEGIN
...
DELIMITER //
CREATE PROCEDURE innerAddJellyCandy(IN id INT, IN name_in VARCHAR(50), IN producer_in VARCHAR(50), IN type_in VARCHAR(50),
                                    IN flavour_in INT UNSIGNED, mass_in INT UNSIGNED)
  BEGIN
    INSERT INTO jellyCandy(id, producer, name, type, flavour, mass)
    VALUES (
      id,
      producer_in,
      name_in,
...
DELIMITER //
CREATE OR REPLACE PROCEDURE addJellyCandy(IN id INT, IN name VARCHAR(50), IN producer VARCHAR(50), IN type VARCHAR(50),
                                          IN flavour INT UNSIGNED, mass INT UNSIGNED)
  BEGIN
...
DELIMITER //
CREATE PROCEDURE innerAddChocolateBar(IN id INT, IN name_in VARCHAR(50), IN producer_in VARCHAR(50),
                                           IN flavour_in INT UNSIGNED, mass_in INT UNSIGNED)
  BEGIN
    INSERT INTO chocolateBar(id, producer, name, flavour, mass)
    VALUES (
      id,
      producer_in,
      name_in,
...
DELIMITER //
CREATE OR REPLACE PROCEDURE addChocolateBar(IN id INT, IN name VARCHAR(50), IN producer VARCHAR(50),
                                            IN flavour INT UNSIGNED, mass INT UNSIGNED)
  BEGIN
...
BEGIN
  UPDATE supplies SET done = 1 WHERE supplySd = in_supply_id;
END //
DELIMITER ;
